...
export class MessagesComponent implements OnInit, OnDestroy {
  ...
  runSubscription() {
    ...
    this.topicSubscription1 = this.rxStompService.watch('/topic/reservations/diningDateTime/' + date).subscribe((message: Message) => {
    ...
    setTimeout(() => {
      ...
      this.topicSubscription2 = this.rxStompService.watch('/topic/diningSpecialRequests/requestDate/' + date).subscribe((message: Message) => {
        this.receivedMessages.push(message.body);
      });
